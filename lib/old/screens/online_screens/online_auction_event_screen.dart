...
class _OnlineEventScreenState extends State<OnlineEventScreen>
  ...
  void initState() {
    ...
    setState(() {
      // v = postmmm[0].postTime!;
      // b = postmmm[0].dateTime!;
    ...
    return BlocConsumer<AuctionCubit, AuctionStates>(
      ...
      builder: (context, state) {
        ...
        return Center(
          ...
          future: AuctionCubit.get(context).getPostById(id: postId),
            ...
            if (snapshot.hasData) {
              return Scaffold(
                ...
                body: Container(
                  ...
                  child: postmmm.startAuction!.isBefore(DateTime.now())
